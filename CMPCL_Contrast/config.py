...
__C.DATASET.CITYSCAPES_DIR = '/mnt/datasets/Cityscapes'
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = '/mnt/datasets/mapillary'
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = '/mnt/datasets/GTA5'
__C.DATASET.BDD_DIR = '/mnt/datasets/bdd-100k'
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = '/mnt/datasets/SYNTHIA'
